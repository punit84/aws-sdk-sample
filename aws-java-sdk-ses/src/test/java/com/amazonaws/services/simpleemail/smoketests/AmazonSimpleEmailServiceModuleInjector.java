...
public class AmazonSimpleEmailServiceModuleInjector implements InjectorSource {
    ...
    public Injector getInjector() {
        return Guice.createInjector(Stage.PRODUCTION, CucumberModules.SCENARIO, new AmazonSimpleEmailServiceModule());
    }

    static class AmazonSimpleEmailServiceModule extends AbstractModule {

        @Override
        protected void configure() {
            bind(AmazonWebServiceClient.class).to(AmazonSimpleEmailServiceClient.class);
        }
    }
}
