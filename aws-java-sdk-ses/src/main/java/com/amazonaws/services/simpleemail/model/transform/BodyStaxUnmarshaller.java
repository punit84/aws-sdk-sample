...
public class BodyStaxUnmarshaller implements Unmarshaller<Body, StaxUnmarshallerContext> {
    ...
    private static BodyStaxUnmarshaller instance;

    public static BodyStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new BodyStaxUnmarshaller();
        return instance;
    }
}
