...
public class TestRenderTemplateRequestMarshaller implements Marshaller<Request<TestRenderTemplateRequest>, TestRenderTemplateRequest> {
    ...
    public Request<TestRenderTemplateRequest> marshall(TestRenderTemplateRequest testRenderTemplateRequest) {
        ...
        Request<TestRenderTemplateRequest> request = new DefaultRequest<TestRenderTemplateRequest>(testRenderTemplateRequest, "AmazonSimpleEmailService");
