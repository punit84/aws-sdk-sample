...
public class InvalidFirehoseDestinationExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("InvalidFirehoseDestination"))
            return null;

        InvalidFirehoseDestinationException e = (InvalidFirehoseDestinationException) super.unmarshall(node);
