...
public class CustomVerificationEmailTemplateDoesNotExistExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("CustomVerificationEmailTemplateDoesNotExist"))
            return null;

        CustomVerificationEmailTemplateDoesNotExistException e = (CustomVerificationEmailTemplateDoesNotExistException) super.unmarshall(node);
