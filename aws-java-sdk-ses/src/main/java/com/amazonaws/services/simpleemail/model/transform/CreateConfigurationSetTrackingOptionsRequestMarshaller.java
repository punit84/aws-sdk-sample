...
public class CreateConfigurationSetTrackingOptionsRequestMarshaller implements
        Marshaller<Request<CreateConfigurationSetTrackingOptionsRequest>, CreateConfigurationSetTrackingOptionsRequest> {

    public Request<CreateConfigurationSetTrackingOptionsRequest> marshall(
        ...
        Request<CreateConfigurationSetTrackingOptionsRequest> request = new DefaultRequest<CreateConfigurationSetTrackingOptionsRequest>(
                createConfigurationSetTrackingOptionsRequest, "AmazonSimpleEmailService");
