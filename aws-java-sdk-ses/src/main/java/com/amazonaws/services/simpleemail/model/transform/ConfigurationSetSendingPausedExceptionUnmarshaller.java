...
public class ConfigurationSetSendingPausedExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("ConfigurationSetSendingPausedException"))
            return null;

        ConfigurationSetSendingPausedException e = (ConfigurationSetSendingPausedException) super.unmarshall(node);
