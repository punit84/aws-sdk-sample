...
/**
 * SetIdentityHeadersInNotificationsEnabledResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SetIdentityHeadersInNotificationsEnabledResultStaxUnmarshaller implements
        Unmarshaller<SetIdentityHeadersInNotificationsEnabledResult, StaxUnmarshallerContext> {

    public SetIdentityHeadersInNotificationsEnabledResult unmarshall(StaxUnmarshallerContext context) throws Exception {
