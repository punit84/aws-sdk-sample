...
/**
 * KinesisFirehoseDestination StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KinesisFirehoseDestinationStaxUnmarshaller implements Unmarshaller<KinesisFirehoseDestination, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("IAMRoleARN", targetDepth)) {
                    kinesisFirehoseDestination.setIAMRoleARN(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("DeliveryStreamARN", targetDepth)) {
                    kinesisFirehoseDestination.setDeliveryStreamARN(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
