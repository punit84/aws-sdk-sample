...
public class SetActiveReceiptRuleSetResultStaxUnmarshaller implements Unmarshaller<SetActiveReceiptRuleSetResult, StaxUnmarshallerContext> {

    public SetActiveReceiptRuleSetResult unmarshall(StaxUnmarshallerContext context) throws Exception {
