...
public class PutIdentityPolicyRequestMarshaller implements Marshaller<Request<PutIdentityPolicyRequest>, PutIdentityPolicyRequest> {
    ...
    public Request<PutIdentityPolicyRequest> marshall(PutIdentityPolicyRequest putIdentityPolicyRequest) {
        ...
        Request<PutIdentityPolicyRequest> request = new DefaultRequest<PutIdentityPolicyRequest>(putIdentityPolicyRequest, "AmazonSimpleEmailService");
        request.addParameter("Action", "PutIdentityPolicy");
        request.addParameter("Version", "2010-12-01");
        request.setHttpMethod(HttpMethodName.POST);

        if (putIdentityPolicyRequest.getIdentity() != null) {
            request.addParameter("Identity", StringUtils.fromString(putIdentityPolicyRequest.getIdentity()));
        }

        if (putIdentityPolicyRequest.getPolicyName() != null) {
            request.addParameter("PolicyName", StringUtils.fromString(putIdentityPolicyRequest.getPolicyName()));
        }
