...
public class CreateConfigurationSetEventDestinationRequestMarshaller implements
    ...
    public Request<CreateConfigurationSetEventDestinationRequest> marshall(
        ...
        Request<CreateConfigurationSetEventDestinationRequest> request = new DefaultRequest<CreateConfigurationSetEventDestinationRequest>(
                createConfigurationSetEventDestinationRequest, "AmazonSimpleEmailService");
        ...
        if (createConfigurationSetEventDestinationRequest.getConfigurationSetName() != null) {
            request.addParameter("ConfigurationSetName", StringUtils.fromString(createConfigurationSetEventDestinationRequest.getConfigurationSetName()));
        }
