...
public class DescribeReceiptRuleResultStaxUnmarshaller implements Unmarshaller<DescribeReceiptRuleResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Rule", targetDepth)) {
                    describeReceiptRuleResult.setRule(ReceiptRuleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
