...
public class VerifyDomainIdentityResultStaxUnmarshaller implements Unmarshaller<VerifyDomainIdentityResult, StaxUnmarshallerContext> {
    ...
    public VerifyDomainIdentityResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("VerificationToken", targetDepth)) {
                    verifyDomainIdentityResult.setVerificationToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
