...
public class GetTemplateRequestMarshaller implements Marshaller<Request<GetTemplateRequest>, GetTemplateRequest> {
    ...
    public Request<GetTemplateRequest> marshall(GetTemplateRequest getTemplateRequest) {
        ...
        Request<GetTemplateRequest> request = new DefaultRequest<GetTemplateRequest>(getTemplateRequest, "AmazonSimpleEmailService");
        request.addParameter("Action", "GetTemplate");
        request.addParameter("Version", "2010-12-01");
        request.setHttpMethod(HttpMethodName.POST);

        if (getTemplateRequest.getTemplateName() != null) {
            request.addParameter("TemplateName", StringUtils.fromString(getTemplateRequest.getTemplateName()));
        }
