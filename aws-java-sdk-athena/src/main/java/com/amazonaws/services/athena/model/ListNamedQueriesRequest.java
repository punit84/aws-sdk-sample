...
public class ListNamedQueriesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The name of the workgroup from which the named queries are being returned. If a workgroup is not specified, the
     ...
     * </p>
     * 
     * @return The name of the workgroup from which the named queries are being returned. If a workgroup is not
     *         specified, the saved queries for the primary workgroup are returned.
     */
