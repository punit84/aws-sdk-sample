...
/**
 * GetTableMetadataResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetTableMetadataResultJsonUnmarshaller implements Unmarshaller<GetTableMetadataResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TableMetadata", targetDepth)) {
                    context.nextToken();
                    getTableMetadataResult.setTableMetadata(TableMetadataJsonUnmarshaller.getInstance().unmarshall(context));
                }
