...
public class ListWorkGroupsRequestMarshaller {
    ...
    public static ListWorkGroupsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListWorkGroupsRequest listWorkGroupsRequest, ProtocolMarshaller protocolMarshaller) {
