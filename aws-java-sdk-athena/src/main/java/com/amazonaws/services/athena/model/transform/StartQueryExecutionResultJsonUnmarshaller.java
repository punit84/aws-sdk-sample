...
/**
 * StartQueryExecutionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartQueryExecutionResultJsonUnmarshaller implements Unmarshaller<StartQueryExecutionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("QueryExecutionId", targetDepth)) {
                    context.nextToken();
                    startQueryExecutionResult.setQueryExecutionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
