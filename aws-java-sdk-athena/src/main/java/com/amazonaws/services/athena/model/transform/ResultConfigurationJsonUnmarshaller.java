...
/**
 * ResultConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResultConfigurationJsonUnmarshaller implements Unmarshaller<ResultConfiguration, JsonUnmarshallerContext> {

    public ResultConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ResultConfigurationJsonUnmarshaller instance;

    public static ResultConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResultConfigurationJsonUnmarshaller();
        return instance;
    }
}
