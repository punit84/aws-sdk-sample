...
public class StopQueryExecutionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique ID of the query execution to stop.
     */
    ...
    @Override
    public StopQueryExecutionRequest clone() {
