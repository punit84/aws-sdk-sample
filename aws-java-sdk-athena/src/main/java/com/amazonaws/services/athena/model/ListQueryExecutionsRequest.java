...
public class ListQueryExecutionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The name of the workgroup from which queries are being returned. If a workgroup is not specified, a list of
     ...
     * </p>
     * 
     * @return The maximum number of query executions to return in this request.
     */
     ...
     * 
     * @param workGroup
     *        The name of the workgroup from which queries are being returned. If a workgroup is not specified, a list
     *        of available query execution IDs for the queries in the primary workgroup is returned.
     */
     ...
     * </p>
     * 
     * @return The name of the workgroup from which queries are being returned. If a workgroup is not specified, a list
     *         of available query execution IDs for the queries in the primary workgroup is returned.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListQueryExecutionsRequest == false)
            return false;
        ListQueryExecutionsRequest other = (ListQueryExecutionsRequest) obj;
    ...
    @Override
    public ListQueryExecutionsRequest clone() {
        return (ListQueryExecutionsRequest) super.clone();
    }
