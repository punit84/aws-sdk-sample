...
/**
 * UpdateNamedQueryResult JSON Unmarshaller
 */
...
public class UpdateNamedQueryResultJsonUnmarshaller implements Unmarshaller<UpdateNamedQueryResult, JsonUnmarshallerContext> {
    ...
    public UpdateNamedQueryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateNamedQueryResult updateNamedQueryResult = new UpdateNamedQueryResult();

        return updateNamedQueryResult;
    }
