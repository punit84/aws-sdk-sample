...
/**
 * UpdatePreparedStatementResult JSON Unmarshaller
 */
...
public class UpdatePreparedStatementResultJsonUnmarshaller implements Unmarshaller<UpdatePreparedStatementResult, JsonUnmarshallerContext> {
    ...
    public UpdatePreparedStatementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePreparedStatementResult updatePreparedStatementResult = new UpdatePreparedStatementResult();

        return updatePreparedStatementResult;
    }
