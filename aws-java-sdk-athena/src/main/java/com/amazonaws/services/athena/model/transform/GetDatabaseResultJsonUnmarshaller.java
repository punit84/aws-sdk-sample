...
/**
 * GetDatabaseResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDatabaseResultJsonUnmarshaller implements Unmarshaller<GetDatabaseResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Database", targetDepth)) {
                    context.nextToken();
                    getDatabaseResult.setDatabase(DatabaseJsonUnmarshaller.getInstance().unmarshall(context));
                }
