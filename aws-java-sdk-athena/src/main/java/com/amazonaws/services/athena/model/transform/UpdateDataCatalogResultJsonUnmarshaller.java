...
/**
 * UpdateDataCatalogResult JSON Unmarshaller
 */
...
public class UpdateDataCatalogResultJsonUnmarshaller implements Unmarshaller<UpdateDataCatalogResult, JsonUnmarshallerContext> {
    ...
    public UpdateDataCatalogResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDataCatalogResult updateDataCatalogResult = new UpdateDataCatalogResult();

        return updateDataCatalogResult;
    }
