...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/athena-2017-05-18/CreatePreparedStatement" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreatePreparedStatementRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreatePreparedStatementRequest withStatementName(String statementName) {
    ...
    public CreatePreparedStatementRequest withWorkGroup(String workGroup) {
    ...
    public CreatePreparedStatementRequest withQueryStatement(String queryStatement) {
    ...
    public CreatePreparedStatementRequest withDescription(String description) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePreparedStatementRequest == false)
            return false;
    ...
    @Override
    public CreatePreparedStatementRequest clone() {
