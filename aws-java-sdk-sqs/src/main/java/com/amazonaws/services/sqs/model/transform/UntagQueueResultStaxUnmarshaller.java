...
/**
 * UntagQueueResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UntagQueueResultStaxUnmarshaller implements Unmarshaller<UntagQueueResult, StaxUnmarshallerContext> {

    public UntagQueueResult unmarshall(StaxUnmarshallerContext context) throws Exception {
