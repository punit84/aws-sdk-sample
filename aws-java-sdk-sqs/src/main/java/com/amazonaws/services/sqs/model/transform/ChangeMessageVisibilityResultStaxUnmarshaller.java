...
/**
 * ChangeMessageVisibilityResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChangeMessageVisibilityResultStaxUnmarshaller implements Unmarshaller<ChangeMessageVisibilityResult, StaxUnmarshallerContext> {

    public ChangeMessageVisibilityResult unmarshall(StaxUnmarshallerContext context) throws Exception {
