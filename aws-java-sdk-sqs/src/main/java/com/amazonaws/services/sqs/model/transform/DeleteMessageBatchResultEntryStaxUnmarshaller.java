...
public class DeleteMessageBatchResultEntryStaxUnmarshaller implements Unmarshaller<DeleteMessageBatchResultEntry, StaxUnmarshallerContext> {
    ...
    public DeleteMessageBatchResultEntry unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    deleteMessageBatchResultEntry.setId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
