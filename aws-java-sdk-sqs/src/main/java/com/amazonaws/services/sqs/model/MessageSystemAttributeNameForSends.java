...
public enum MessageSystemAttributeNameForSends {
     ...
     * @param value
     *        real value
     * @return MessageSystemAttributeNameForSends corresponding to the value
     *
    ...
    public static MessageSystemAttributeNameForSends fromValue(String value) {
        ...
        for (MessageSystemAttributeNameForSends enumEntry : MessageSystemAttributeNameForSends.values()) {
