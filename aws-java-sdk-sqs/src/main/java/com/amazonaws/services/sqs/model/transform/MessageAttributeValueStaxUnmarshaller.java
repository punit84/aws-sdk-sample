        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StringListValue", targetDepth)) {
                    messageAttributeValue.withStringListValues(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("BinaryListValue", targetDepth)) {
                    messageAttributeValue.withBinaryListValues(ByteBufferStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
