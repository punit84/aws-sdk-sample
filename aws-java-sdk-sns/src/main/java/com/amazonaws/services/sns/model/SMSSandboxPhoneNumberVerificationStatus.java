 ...
 * supported. 1. PENDING : The destination phone number is pending verification. 2. VERIFIED : The destination phone
 * number is verified.
 */
...
public enum SMSSandboxPhoneNumberVerificationStatus {
     ...
     * @param value
     *        real value
     * @return SMSSandboxPhoneNumberVerificationStatus corresponding to the value
     *
    ...
    public static SMSSandboxPhoneNumberVerificationStatus fromValue(String value) {
        ...
        for (SMSSandboxPhoneNumberVerificationStatus enumEntry : SMSSandboxPhoneNumberVerificationStatus.values()) {
