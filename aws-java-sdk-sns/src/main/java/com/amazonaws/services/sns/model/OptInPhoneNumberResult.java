...
public class OptInPhoneNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OptInPhoneNumberResult == false)
            return false;
        OptInPhoneNumberResult other = (OptInPhoneNumberResult) obj;
        return true;
    }
    ...
    @Override
    public OptInPhoneNumberResult clone() {
        try {
            return (OptInPhoneNumberResult) super.clone();
