...
/**
 * SMSSandboxPhoneNumber StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SMSSandboxPhoneNumberStaxUnmarshaller implements Unmarshaller<SMSSandboxPhoneNumber, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PhoneNumber", targetDepth)) {
                    sMSSandboxPhoneNumber.setPhoneNumber(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Status", targetDepth)) {
                    sMSSandboxPhoneNumber.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
