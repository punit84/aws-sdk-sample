...
/**
 * AddPermissionResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddPermissionResultStaxUnmarshaller implements Unmarshaller<AddPermissionResult, StaxUnmarshallerContext> {

    public AddPermissionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
