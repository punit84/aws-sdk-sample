...
public class GetSMSSandboxAccountStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetSMSSandboxAccountStatusRequest clone() {
        return (GetSMSSandboxAccountStatusRequest) super.clone();
    }
