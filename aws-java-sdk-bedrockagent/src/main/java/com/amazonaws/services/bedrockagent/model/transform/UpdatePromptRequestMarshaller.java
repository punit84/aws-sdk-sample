...
public class UpdatePromptRequestMarshaller {
    ...
    public void marshall(UpdatePromptRequest updatePromptRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updatePromptRequest.getCustomerEncryptionKeyArn(), CUSTOMERENCRYPTIONKEYARN_BINDING);
            protocolMarshaller.marshall(updatePromptRequest.getDefaultVariant(), DEFAULTVARIANT_BINDING);
            ...
            protocolMarshaller.marshall(updatePromptRequest.getPromptIdentifier(), PROMPTIDENTIFIER_BINDING);
            protocolMarshaller.marshall(updatePromptRequest.getVariants(), VARIANTS_BINDING);
        } catch (Exception e) {
