...
public class CreateFlowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The status of the flow. When you submit this request, the status will be <code>NotPrepared</code>. If creation
    ...
    public CreateFlowResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateFlowResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the KMS key that you encrypted the flow with.
     */
    ...
    public CreateFlowResult withCustomerEncryptionKeyArn(String customerEncryptionKeyArn) {
    ...
    public CreateFlowResult withDefinition(FlowDefinition definition) {
    ...
    public CreateFlowResult withDescription(String description) {
    ...
    public CreateFlowResult withExecutionRoleArn(String executionRoleArn) {
    ...
    public CreateFlowResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateFlowResult withName(String name) {
        setName(name);
        return this;
    }
     ...
     *        creation fails, the status becomes <code>Failed</code>.
     * @see FlowStatus
     */
    ...
    public CreateFlowResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public CreateFlowResult withStatus(FlowStatus status) {
    ...
    public CreateFlowResult withUpdatedAt(java.util.Date updatedAt) {
     ...
     * </p>
     * 
     * @return The version of the flow. When you create a flow, the version created is the <code>DRAFT</code> version.
     */
    ...
    public CreateFlowResult withVersion(String version) {
        setVersion(version);
        return this;
    }
