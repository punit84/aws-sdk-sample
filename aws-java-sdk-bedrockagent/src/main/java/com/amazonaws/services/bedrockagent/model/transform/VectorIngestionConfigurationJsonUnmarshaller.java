...
/**
 * VectorIngestionConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VectorIngestionConfigurationJsonUnmarshaller implements Unmarshaller<VectorIngestionConfiguration, JsonUnmarshallerContext> {

    public VectorIngestionConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        VectorIngestionConfiguration vectorIngestionConfiguration = new VectorIngestionConfiguration();
    ...
    private static VectorIngestionConfigurationJsonUnmarshaller instance;

    public static VectorIngestionConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VectorIngestionConfigurationJsonUnmarshaller();
        return instance;
    }
}
