...
/**
 * DeleteFlowResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFlowResultJsonUnmarshaller implements Unmarshaller<DeleteFlowResult, JsonUnmarshallerContext> {

    public DeleteFlowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFlowResult deleteFlowResult = new DeleteFlowResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    deleteFlowResult.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
