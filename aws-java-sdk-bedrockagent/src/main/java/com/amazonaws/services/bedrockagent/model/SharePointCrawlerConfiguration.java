 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-2023-06-05/SharePointCrawlerConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SharePointCrawlerConfiguration implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * The configuration of filtering the SharePoint content. For example, configuring regular expression patterns to
     ...
     * </p>
     * 
     * @return The configuration of filtering the SharePoint content. For example, configuring regular expression
     *         patterns to include or exclude certain content.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SharePointCrawlerConfiguration == false)
            return false;
        SharePointCrawlerConfiguration other = (SharePointCrawlerConfiguration) obj;
    ...
    public SharePointCrawlerConfiguration clone() {
        try {
            return (SharePointCrawlerConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.bedrockagent.model.transform.SharePointCrawlerConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
