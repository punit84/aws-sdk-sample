...
/**
 * ChunkingConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChunkingConfigurationJsonUnmarshaller implements Unmarshaller<ChunkingConfiguration, JsonUnmarshallerContext> {

    public ChunkingConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ChunkingConfiguration chunkingConfiguration = new ChunkingConfiguration();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("chunkingStrategy", targetDepth)) {
                    context.nextToken();
                    chunkingConfiguration.setChunkingStrategy(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ChunkingConfigurationJsonUnmarshaller instance;

    public static ChunkingConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ChunkingConfigurationJsonUnmarshaller();
        return instance;
    }
}
