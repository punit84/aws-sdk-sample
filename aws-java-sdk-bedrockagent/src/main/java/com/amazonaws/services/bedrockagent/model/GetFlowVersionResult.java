...
public class GetFlowVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetFlowVersionResult withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFlowVersionResult == false)
            return false;
        GetFlowVersionResult other = (GetFlowVersionResult) obj;
    ...
    public GetFlowVersionResult clone() {
        try {
            return (GetFlowVersionResult) super.clone();
