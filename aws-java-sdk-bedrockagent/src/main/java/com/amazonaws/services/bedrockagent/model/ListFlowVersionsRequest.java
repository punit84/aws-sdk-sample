...
public class ListFlowVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFlowVersionsRequest withFlowIdentifier(String flowIdentifier) {
    ...
    public ListFlowVersionsRequest withMaxResults(Integer maxResults) {
    ...
    public ListFlowVersionsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFlowVersionsRequest == false)
            return false;
        ListFlowVersionsRequest other = (ListFlowVersionsRequest) obj;
    ...
    @Override
    public ListFlowVersionsRequest clone() {
        return (ListFlowVersionsRequest) super.clone();
    }
