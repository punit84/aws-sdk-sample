...
public class GetFlowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetFlowRequest withFlowIdentifier(String flowIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFlowRequest == false)
            return false;
        GetFlowRequest other = (GetFlowRequest) obj;
    ...
    public GetFlowRequest clone() {
        return (GetFlowRequest) super.clone();
    }
