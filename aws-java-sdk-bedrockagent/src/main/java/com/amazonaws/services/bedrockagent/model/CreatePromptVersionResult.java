...
public class CreatePromptVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the version of the prompt.
     */
    ...
    public CreatePromptVersionResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the KMS key to encrypt the version of the prompt.
     */
    ...
    public CreatePromptVersionResult withDefaultVariant(String defaultVariant) {
     ...
     * </p>
     * 
     * @return A description for the prompt version.
     */
     ...
     * </p>
     * 
     * @return The name of the prompt version.
     */
    ...
    public CreatePromptVersionResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public CreatePromptVersionResult withVariants(PromptVariant... variants) {
    ...
    public CreatePromptVersionResult withVariants(java.util.Collection<PromptVariant> variants) {
     ...
     * </p>
     * 
     * @return The version of the prompt that was created. Versions are numbered incrementally, starting from 1.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePromptVersionResult == false)
            return false;
        CreatePromptVersionResult other = (CreatePromptVersionResult) obj;
    ...
    public CreatePromptVersionResult clone() {
        try {
            return (CreatePromptVersionResult) super.clone();
