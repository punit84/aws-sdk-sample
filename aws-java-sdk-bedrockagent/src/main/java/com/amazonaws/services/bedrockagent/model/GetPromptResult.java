...
public class GetPromptResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetPromptResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the KMS key that the prompt is encrypted with.
     */
    ...
    public GetPromptResult withDefaultVariant(String defaultVariant) {
     ...
     * </p>
     * 
     * @return The descriptino of the prompt.
     */
    ...
    public GetPromptResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public GetPromptResult withVariants(PromptVariant... variants) {
    ...
    public GetPromptResult withVariants(java.util.Collection<PromptVariant> variants) {
     ...
     * </p>
     * 
     * @return The version of the prompt.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPromptResult == false)
            return false;
        GetPromptResult other = (GetPromptResult) obj;
