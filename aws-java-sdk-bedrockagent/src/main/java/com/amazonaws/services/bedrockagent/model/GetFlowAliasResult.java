...
public class GetFlowAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetFlowAliasResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetFlowAliasResult withRoutingConfiguration(FlowAliasRoutingConfigurationListItem... routingConfiguration) {
    ...
    public GetFlowAliasResult withRoutingConfiguration(java.util.Collection<FlowAliasRoutingConfigurationListItem> routingConfiguration) {
    ...
    public GetFlowAliasResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFlowAliasResult == false)
            return false;
        GetFlowAliasResult other = (GetFlowAliasResult) obj;
    ...
    public GetFlowAliasResult clone() {
        try {
            return (GetFlowAliasResult) super.clone();
