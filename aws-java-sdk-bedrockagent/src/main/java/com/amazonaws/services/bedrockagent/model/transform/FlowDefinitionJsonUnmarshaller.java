        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("connections", targetDepth)) {
                    context.nextToken();
                    flowDefinition.setConnections(new ListUnmarshaller<FlowConnection>(FlowConnectionJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nodes", targetDepth)) {
                    context.nextToken();
                    flowDefinition.setNodes(new ListUnmarshaller<FlowNode>(FlowNodeJsonUnmarshaller.getInstance())
